        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="https://g.co/kgs/2i4p4J6" target='_blank'>Location: 1915-P Sector-3 Rohtak-124001</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.google.com/search?client=ms-android-oneplus-terr1-rso3&sca_esv=b50dc48a566d410b&hl=en-GB&cs=0&sxsrf=AE3TifMIEVYLKDv9LPSeuQIgvUzo51SNHQ:1749873328207&kgmid=/g/1pp2vh0cq&q=Ahlawat+Dental+I+Dentist+In+Rohtak+I+Better+Dental+Treatment+I+Dentist+near+me+I+Orthodontist+I+RCT+%26+Implant+centre&shndl=30&shem=lspt2&source=sh/x/loc/act/m1/4&kgs=1524534d18784f87" target='_blank' className="text-gray-400 hover:text-white">
              <FaMapMarkerAlt className="text-2xl"/>
              </a>
             
              <a href="https://www.instagram.com/ahlawatdentalcare?igsh=MTl4eTVvMmJscDBvbQ==" target='_blank' className="text-gray-400 hover:text-white">
